        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= base_url() ?>Pelanggan/editData" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="id" id="id" value="<?= $t['orderId']; ?>"/>
                        ...
                        <div class="form-group">
                            <label>Note</label>
                            <textarea class="form-control" name="note" id="note" cols="30" rows="10" readonly><?= $t['note']; ?></textarea>
                        </div>
                        <div class="form-group">
                            <label>Expired</label>
